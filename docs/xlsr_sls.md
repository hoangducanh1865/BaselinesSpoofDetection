...
```bash
python main.py --baseline xlsr_sls --mode eval --dataset dfadd_test --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset fake_or_real_norm --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset vlsp2025 --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset vsasv --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset in_the_wild --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset asvspoof2019la --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset asvspoof2021la --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset asvspoof2021df --ckpt "$XLSR_SLS_CKPT_2019"
python main.py --baseline xlsr_sls --mode eval --dataset asvspoof5 --ckpt "$XLSR_SLS_CKPT_2019"
```
